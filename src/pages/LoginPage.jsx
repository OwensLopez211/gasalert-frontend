...
const LoginPage = () => {
  ...
  return (
    <div className="relative flex size-full min-h-screen flex-col bg-[#181311] dark group/design-root overflow-x-hidden" style={{ fontFamily: 'Inter, "Noto Sans", sans-serif' }}>
      <div className="layout-container flex h-full grow flex-col">
        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 max-w-[960px] flex-1">
            <h2 className="text-white tracking-light text-[28px] font-bold leading-tight px-4 text-left pb-3 pt-5">Bienvenido a GasAlert</h2>
            <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
              Inicia sesión para monitorear tus tanques de combustible y recibir alertas. Si no tienes una cuenta, regístrate para una demostración.
            </p>
            <form onSubmit={handleLogin}>
              ...
              <p className="text-[#b9a49d] text-sm font-normal leading-normal pb-3 pt-1 px-4 underline">¿Olvidaste tu contraseña?</p>
